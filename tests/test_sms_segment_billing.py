...
class TestSMSSegmentBilling:
    ...
    async def test_messaging_service_calls_billing_with_segments(self):
        ...
        with patch("src.services.messaging_service.AsyncSessionLocal") as mock_db_session_cls, \
             patch("src.services.sms_factory.get_sms_service") as mock_get_sms, \
             patch("src.services.billing_service.BillingService") as mock_billing_service_cls:
