...
def sample_employees():
    emp1 = User(
        id=1, default_start_location_lat=40.7306, default_start_location_lng=-73.9352
    )  # Brooklyn
    emp2 = User(
        id=2, default_start_location_lat=34.0522, default_start_location_lng=-118.2437
    )  # LA
    emp3 = User(
        id=3, default_start_location_lat=None, default_start_location_lng=None
    )  # No location
...
def test_ors_adapter_build_payload(sample_jobs, sample_employees):
    ...
    assert job1_payload["time_windows"][0] == [
