...
async def test_tool_executor_add_job_safeguard_blocked():
    ...
    executor.geocoding_service.geocode.return_value = (
        None,
        None,
        None,
        None,
...
async def test_tool_executor_add_job_safeguard_allowed():
    ...
    with patch("src.tool_executor.CRMService") as mock_crm:
        ...
        mock_crm_instance.create_job.return_value = MagicMock(
            id=123,
            value=100.0,
            customer=MagicMock(name="John Doe"),
            location="Main St, Dublin",
            description="Clean windows",
        )
        ...
        tool = AddJobTool(
            customer_name="John Doe", location="Main St", description="Clean windows"
        )
