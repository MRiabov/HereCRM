...
async def test_add_job_creates_customer_with_defaults(db_session, setup_user):
    ...
    with patch("src.events.EventBus.emit", new_callable=AsyncMock) as mock_emit:
        with patch("src.tool_executor.GeocodingService") as MockGeoTool, \
            ...
            defaults = (1.0, 2.0, "Street", "DefaultCity", "DefaultCountry", "54321", "Street, DefaultCity, DefaultCountry, 54321")
