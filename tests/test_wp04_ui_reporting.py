...
@pytest.mark.asyncio
async def test_wp04_show_job_with_line_items(db_session: AsyncSession, template_service):
    # Setup
    business = Business(name="WP04 Business")
...
@pytest.mark.asyncio
async def test_wp04_confirmation_with_line_items(db_session: AsyncSession, template_service):
    # Setup
    business = Business(name="WP04 Business")
    db_session.add(business)
    await db_session.flush()
