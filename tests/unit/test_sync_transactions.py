...
class TestInvoiceSyncer:
    ...
    def test_map_record_dependency_missing_customer(
        self, invoice_syncer, mock_invoice_data
    ):
    ...
    def test_map_record_dependency_missing_service(
        self, invoice_syncer, mock_invoice_data
    ):
    ...
    def test_validate_record_success(self, invoice_syncer):
        ...
        data = {"CustomerRef": {"value": "C_1"}, "Line": [{"Amount": 100.0}]}
    ...
    def test_validate_record_no_lines(self, invoice_syncer):
        ...
        data = {"CustomerRef": {"value": "C_1"}, "Line": []}
        assert "must have at least one line item" in invoice_syncer._validate_record(
            data
        )
...
class TestPaymentSyncer:
    ...
    def test_map_record_dependency_missing_invoice(
        self, payment_syncer, mock_payment_data
    ):
