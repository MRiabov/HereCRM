...
class TestMainDatabaseModels:
    ...
    def test_business_creation(self, temp_db):
        ...
        business = Business(
            name="Test Business", quickbooks_connected=False, quickbooks_last_sync=None
        )
...
class TestCredentialsDatabase:
    ...
    def test_credential_encryption(self, temp_credentials_db):
        ...
        retrieved = (
            temp_credentials_db.query(QuickBooksCredential)
            .filter_by(business_id=2)
            .first()
        )
...
class TestDatabaseConnection:
    ...
    def test_credentials_db_file_creation(self):
        ...
        if PYSQLCIPHER_AVAILABLE:
            ...
            inspector = credentials_engine.dialect.get_columns(
                credentials_engine, "quickbooks_credentials"
            )
