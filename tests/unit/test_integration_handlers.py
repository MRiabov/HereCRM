...
async def test_handle_job_booked_dispatches_webhook():
    # Setup test data
    data = {"job_id": 1, "business_id": 100, "value": 250.0}
    ...
    with (
        patch(
            "src.handlers.integration_handlers.IntegrationRepository"
        ) as MockIntegrationRepo,
        ...
        with patch("httpx.AsyncClient.post") as mock_post:
            ...
            # Assertions
            instance_int.get_active_by_type.assert_called_once_with(
                100, IntegrationType.WEBHOOK
            )
