...
2. **System** displays: "Click here to connect your QuickBooks account: [OAuth Link]"
...
1. **Business Owner** types: "Sync QuickBooks now"
2. **System** initiates immediate sync outside scheduled time
3. **System** processes all pending records
4. **System** displays: "✅ QuickBooks sync completed. 7 records synced successfully."
...
1. **Business Owner** types: "QuickBooks status"
2. **System** displays: :
...
1. **Business Owner** types: "Disconnect QuickBooks"
...
5. **System** displays: "QuickBooks disconnected. You can reconnect anytime."
