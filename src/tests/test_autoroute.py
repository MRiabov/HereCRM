...
@pytest.mark.asyncio
async def test_autoroute_preview_success(session: AsyncSession, mock_routing_service, template_service, monkeypatch):
    # Setup Data
    # 1. Employee
    emp = User(
    ...
    monkeypatch.setattr("src.tools.routing_tools.OpenRouteServiceAdapter", mock_adapter_cls)
