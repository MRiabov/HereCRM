        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                if response.status_code == 200:
                    ...
                    )  # Always pending review initially
                else:
                ...
                for rt in remote_templates:
                    ...
                    if local_tmpl:
                        ...
                        new_status = status_map.get(
                            rt.get("status"), WhatsAppTemplateStatus.DRAFT
                        )
                        ...
                        new_tmpl = WhatsAppTemplate(
                            ...
                            category=WhatsAppTemplateCategory(rt.get("category"))
                            if rt.get("category")
                            in WhatsAppTemplateCategory.__members__
                            else WhatsAppTemplateCategory.UTILITY,
