...
class IntegrationService:
    ...
    async def create_inbound_integration(self, business_id: int, label: str) -> Tuple[IntegrationConfig, str]:
        """
    ...
    async def get_active_configs_by_type(self, business_id: int, type: IntegrationType) -> List[IntegrationConfig]:
