...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column(
        "businesses", sa.Column("stripe_customer_id", sa.String(), nullable=True)
    )
    op.add_column(
        "businesses", sa.Column("stripe_subscription_id", sa.String(), nullable=True)
    )
    op.add_column(
        "businesses",
        sa.Column(
    ...
    op.add_column(
        "businesses",
        sa.Column("active_addons", sa.JSON(), nullable=False, server_default="[]"),
    )
