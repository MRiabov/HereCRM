...
def upgrade() -> None:
    ...
    op.add_column(
        "businesses",
        sa.Column(
            "quickbooks_connected", sa.Boolean(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "businesses", sa.Column("quickbooks_last_sync", sa.DateTime(), nullable=True)
    )
    ...
    op.add_column(
        "customers", sa.Column("quickbooks_synced_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "customers",
        sa.Column("quickbooks_sync_status", sync_status_enum, nullable=True),
    )
    op.add_column(
        "customers", sa.Column("quickbooks_sync_error", sa.Text(), nullable=True)
    )
    ...
    op.add_column(
        "services", sa.Column("quickbooks_synced_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "services", sa.Column("quickbooks_sync_status", sync_status_enum, nullable=True)
    )
    op.add_column(
        "services", sa.Column("quickbooks_sync_error", sa.Text(), nullable=True)
    )
    ...
    op.add_column(
        "invoices", sa.Column("quickbooks_synced_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "invoices", sa.Column("quickbooks_sync_status", sync_status_enum, nullable=True)
    )
    op.add_column(
        "invoices", sa.Column("quickbooks_sync_error", sa.Text(), nullable=True)
    )
    ...
    op.add_column(
        "payments", sa.Column("quickbooks_synced_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "payments", sa.Column("quickbooks_sync_status", sync_status_enum, nullable=True)
    )
    op.add_column(
        "payments", sa.Column("quickbooks_sync_error", sa.Text(), nullable=True)
    )
    ...
    op.add_column(
        "quotes", sa.Column("quickbooks_synced_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "quotes", sa.Column("quickbooks_sync_status", sync_status_enum, nullable=True)
    )
    op.add_column(
        "quotes", sa.Column("quickbooks_sync_error", sa.Text(), nullable=True)
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "sync_type",
            sa.Enum("scheduled", "manual", name="sync_type"),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "records_succeeded", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("records_failed", sa.Integer(), nullable=False, server_default="0"),
        sa.Column(
            "status",
            sa.Enum("success", "partial_success", "failed", name="sync_log_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_sync_logs_business_timestamp",
        "sync_logs",
