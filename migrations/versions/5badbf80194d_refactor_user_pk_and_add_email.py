...
def upgrade() -> None:
    ...
    op.create_table('conversation_states_new',
        sa.Column('user_id', sa.Integer(), sa.ForeignKey('users_new.id'), primary_key=True),
...
def downgrade() -> None:
    ...
    op.add_column('conversation_states', sa.Column('phone_number', sa.String(), nullable=True))
    op.execute("""
    ...
    op.create_table('conversation_states_old',
        sa.Column('phone_number', sa.String(), primary_key=True),
        sa.Column('state', sa.String(), nullable=False),
        sa.Column('draft_data', sa.JSON(), nullable=True),
        sa.Column('last_action_metadata', sa.JSON(), nullable=True),
