...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_quotes_external_token'), 'quotes', ['external_token'], unique=True)
    ...
    with op.batch_alter_table('conversation_states', schema=None) as batch_op:
        batch_op.add_column(sa.Column('pending_action_timestamp', sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column('pending_action_payload', sa.JSON(), nullable=True))
        batch_op.add_column(sa.Column('active_channel', sa.String(), nullable=False, server_default='whatsapp'))

    with op.batch_alter_table('messages', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_messages_user_id', 'users', ['user_id'], ['id'])

    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('preferred_channel', sa.String(), nullable=False, server_default='whatsapp'))
