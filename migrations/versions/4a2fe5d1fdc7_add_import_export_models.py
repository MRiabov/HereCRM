...
Revision ID: 4a2fe5d1fdc7
Revises: 29221d00596e
Create Date: 2026-01-17 18:42:21.933798
...
revision: str = '4a2fe5d1fdc7'
down_revision: Union[str, Sequence[str], None] = '29221d00596e'
...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('IDLE', 'WAITING_CONFIRM', 'SETTINGS', 'DATA_MANAGEMENT', name='conversationstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_requests_business_id'), 'requests', ['business_id'], unique=False)
    ...
    op.create_index(op.f('ix_line_items_job_id'), 'line_items', ['job_id'], unique=False)
